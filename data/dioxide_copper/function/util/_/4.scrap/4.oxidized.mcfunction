...
# block
    $fill $(from) $(to) oxidized_copper replace waxed_oxidized_copper
    $fill $(from) $(to) oxidized_cut_copper replace waxed_oxidized_cut_copper
    $fill $(from) $(to) oxidized_copper_grate replace waxed_oxidized_copper_grate
    $fill $(from) $(to) oxidized_chiseled_copper replace waxed_oxidized_chiseled_copper
