...
# slab
    data modify storage dioxide_copper:input _.a set value "oxidized_cut_copper_slab"
...
# stairs
    data modify storage dioxide_copper:input _.a set value "oxidized_cut_copper_stairs"
...
# bulb
    data modify storage dioxide_copper:input _.a set value "oxidized_copper_bulb"
...
# trapdoor
    data modify storage dioxide_copper:input _.a set value "oxidized_copper_trapdoor"
...
# trapdoor
    data modify storage dioxide_copper:input _.a set value "oxidized_copper_door"
